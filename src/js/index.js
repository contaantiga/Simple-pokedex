...
- ao cliclar em um pokemon da listagem pegamos o id desse pokemon pra saber qual cartao mostrar 
...
listaSelecaoPokemons.forEach(pokemon => {
    // evento de clique feito pelo usuario na listagem de pokemons 
